---
title: "DSApps 2021 @ TAU: Assignment 6"
...
* You need to `git clone` your private Github repository locally as explained [here](https://github.com/DSApps-2021/Class_Slides/blob/master/Apps_of_DS_HW.pdf)
...
* Commit your work and push to your private Github repository as explained [here](https://github.com/DSApps-2021/Class_Slides/blob/master/Apps_of_DS_HW.pdf)

This assignemtnt is due: 31/5 23:59
...
Be sure to visit our [Leaderboard](https://dsapps-2021.github.io/Class_Slides/leaderboard.html) to see the best scores.
...
pred_price_cat_cond_brand <- shoes_train_te %>%
  inner_join(tr_price_mean_cat_cond_brand, by = c("category", "condition", "brand")) %>%
  pull(price_mean)
...
Drop me a mail either by actually sending me a mail or opening an issue in your repo and assigning it to me, and wait to see your result on the [Leaderboard!](https://dsapps-2021.github.io/Class_Slides/leaderboard.html)
